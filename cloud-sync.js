...
(function(){
  ...
  function showEntrySync(show){
    ...
    q('entryLoading')?.classList.add('hidden');
    q('entrySignedOut')?.classList.add('hidden');
    q('entryConfirmEmail')?.classList.add('hidden');
    q('entryCompanySetup')?.classList.add('hidden');
    q('entrySyncing')?.classList.toggle('hidden',!show);
    if(show)gate.classList.remove('hidden');
  }
