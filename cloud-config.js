/* AngebotsPilot v11.32.11 – zentrale Runtime + Compliance Loader
...
(function installAngebotsPilotRuntime(){
  ...
  const DATA_SAFETY_SRC='./data-safety.js?v=11.32.11';
  const COMPLIANCE_SRC='./compliance-v1131.js?v=11.32.11';
  const COMPLIANCE_HARDENING_SRC='./compliance-v113108.js?v=11.32.11';
  const COMPLIANCE_SERVER_SRC='./compliance-v113128.js?v=11.32.11';
  const COMPLIANCE_ZUGFERD_SRC='./compliance-v113131.js?v=11.32.11';
