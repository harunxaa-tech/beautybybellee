/* AngebotsPilot v11.31.23 – serverseitige XRechnungs-Validierung
...
(function installServerXRechnungValidation(){
  ...
  const RUNTIME_VERSION='11.31.23';
  ...
  // v11.31.23: UBL MonetaryTotal hat eine feste Elementreihenfolge.
  ...
  function install(base){
    ...
    // v11.31.23 darf auch über 11.31.18/19 gelegt werden: die XML-Normalisierung
    ...
    function check(inv){
      // v11.31.23: wichtig – den unveränderten Basis-Check aufrufen.
    ...
    async function validatorJob(inv){
      ...
      return{
        ...
        xmlFixes:{legalMonetaryTotalOrder:'v11.31.23',inputReadiness:'tax-id-and-iban',sellerIdentifier:'BT-29-from-existing-tax-or-vat-id',loaderFix:'current-layer-v11.31.23',localPreflight:'before-server',recursionFix:'v11.31.23',loaderUpgrade:'forced-current-server-layer'}
      };
    }
  ...
  const timer=setInterval(()=>{
    ...
    if(tries>200){clearInterval(timer);console.error('AngebotsPilot v11.31.23 Server-Validierung konnte nicht installiert werden.')}
  },50);
