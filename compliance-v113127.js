/* AngebotsPilot v11.31.27 – serverseitige XRechnungs-Validierung
...
(function installServerXRechnungValidation(){
  ...
  const RUNTIME_VERSION='11.31.27';
  ...
  // v11.31.27: UBL MonetaryTotal hat eine feste Elementreihenfolge.
  ...
  // v11.31.27: XRechnung verlangt auch bei Gutschrift/Storno Zahlungsanweisungen (BG-16).
  ...
  function install(base){
    ...
    // v11.31.27 darf auch über 11.31.18/19 gelegt werden: die XML-Normalisierung
    ...
    if(![BASE_VERSION,'11.31.16','11.31.17','11.31.18','11.31.19','11.31.20','11.31.21','11.31.22','11.31.23','11.31.24','11.31.25','11.31.26'].includes(base.runtimeVersion))return false;
    ...
    function check(inv){
      // v11.31.27: wichtig – den unveränderten Basis-Check aufrufen.
    ...
    async function validatorJob(inv){
      ...
      return{
        ...
        xmlFixes:{legalMonetaryTotalOrder:'v11.31.27',paymentInstructions:'BG-16-creditnote-and-invoice',inputReadiness:'tax-id-iban-and-payment',sellerIdentifier:'BT-29-normalized-after-EndpointID',loaderFix:'current-layer-v11.31.27',localPreflight:'before-server',recursionFix:'v11.31.27',loaderUpgrade:'forced-current-server-layer'}
      };
    }
  ...
  globalThis.APComplianceUpgradeTo113127=install;

  let tries=0;
  const timer=setInterval(()=>{
    tries++;
    if(install(globalThis.APCompliance)){clearInterval(timer);return}
    if(tries>200){clearInterval(timer);console.error('AngebotsPilot v11.31.27 Server-Validierung konnte nicht installiert werden.')}
  },50);
