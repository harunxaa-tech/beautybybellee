...
function newEvent(){document.getElementById('eventEditorTitle').textContent='Neuer Termin';document.getElementById('eventId').value='';document.getElementById('eventTitle').value='';document.getElementById('eventCustomer').innerHTML=customerOptions();document.getElementById('eventDate').value=todayISO();document.getElementById('eventTime').value='08:00';document.getElementById('eventDuration').value=60;document.getElementById('eventType').value='Baustelle';document.getElementById('eventAddress').value='';document.getElementById('eventAddress').dataset.autoFilled='1';document.getElementById('eventNotes').value='';showScreen('eventEditor')}
function editEvent(id){const e=data.events.find(x=>x.id===id);if(!e)return;document.getElementById('eventId').value=e.id;document.getElementById('eventTitle').value=e.title;document.getElementById('eventCustomer').innerHTML=customerOptions(e.customerId);document.getElementById('eventDate').value=e.date;document.getElementById('eventTime').value=e.time;document.getElementById('eventDuration').value=e.duration;document.getElementById('eventType').value=e.type;document.getElementById('eventAddress').value=e.address||'';document.getElementById('eventAddress').dataset.autoFilled='0';document.getElementById('eventNotes').value=e.notes||'';showScreen('eventEditor')}
function saveEvent(){const id=document.getElementById('eventId').value,cid=document.getElementById('eventCustomer').value,old=id?data.events.find(x=>x.id===id):null,obj={id:id||uid(),title:document.getElementById('eventTitle').value.trim(),customerId:cid,date:document.getElementById('eventDate').value,time:document.getElementById('eventTime').value,duration:Number(document.getElementById('eventDuration').value)||60,type:document.getElementById('eventType').value,address:document.getElementById('eventAddress').value.trim(),notes:document.getElementById('eventNotes').value.trim(),jobId:old?.jobId||''};if(!obj.title)return toast('Titel fehlt');if(id)data.events[data.events.findIndex(x=>x.id===id)]=obj;else data.events.push(obj);syncLinkedJobFromEvent(obj);saveData('Termin gespeichert',obj.title);showScreen('calendar');toast(obj.jobId?'Termin gespeichert · Baustelle aktualisiert':'Termin gespeichert')}
