...
const PRODUCT_TOUR_STEPS=[
  ...
  {screen:'today',selector:'.bottomNav [data-screen="today"]',icon:'✓',title:'Startklar',text:'Das war die ganze App. Merke dir nur den Ablauf: Kunde → Angebot → Baustelle dokumentieren → Abschluss → Rechnung. Den Rest findest du unterwegs.'}
]
...
function newJobForCustomer(customerId){newJob();document.getElementById('jobCustomer').value=customerId;refreshJobOfferOptions()}
...
function newJob(){document.getElementById('jobId').value='';document.getElementById('jobTitle').value='';document.getElementById('jobCustomer').innerHTML=customerOptions();document.getElementById('jobAddress').value='';document.getElementById('jobStart').value=todayISO();document.getElementById('jobStatus').value='open';document.getElementById('jobNotes').value='';document.getElementById('jobOffer').innerHTML=acceptedOfferOptions();jobDraftPhotos=[];document.getElementById('jobDocNote').value='';renderJobPhotos();showScreen('jobEditor')}
