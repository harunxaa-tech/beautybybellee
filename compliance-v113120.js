/* AngebotsPilot v11.31.20 – serverseitige XRechnungs-Validierung
...
(function installServerXRechnungValidation(){
  ...
  const RUNTIME_VERSION='11.31.20';
  ...
  // v11.31.20: UBL MonetaryTotal hat eine feste Elementreihenfolge.
  ...
  function install(base){
    ...
    // v11.31.20 darf auch über 11.31.18/19 gelegt werden: die XML-Normalisierung
    ...
    async function validatorJob(inv){
      ...
      return{
        ...
        xmlFixes:{legalMonetaryTotalOrder:'v11.31.20',inputReadiness:'tax-id-and-iban',loaderUpgrade:'forced-current-server-layer'}
      };
    }
    ...
    window.dispatchEvent(new CustomEvent('angebotspilot:compliance-ready',{detail:{
      ...
      xmlSchemaFix:'LegalMonetaryTotal-order',inputReadiness:'tax-id-and-iban'
    }}));
  ...
  const timer=setInterval(()=>{
    ...
    if(tries>200){clearInterval(timer);console.error('AngebotsPilot v11.31.20 Server-Validierung konnte nicht installiert werden.')}
  },50);
