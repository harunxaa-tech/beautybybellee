const CACHE='angebotspilot-v11-23';
const ASSETS=[
  './','./index.html','./style.css?v=11.23','./cloud-config.js?v=11.23',
  './country-config.js?v=11.23','./data-repository.js?v=11.23','./einvoice.js?v=11.23','./script.js?v=11.23','./cloud-files.js?v=11.23','./cloud-sync.js?v=11.23',
  './team.js?v=11.23','./assignments.js?v=11.23','./time-tracking.js?v=11.23','./notifications.js?v=11.23','./mail-hub.js?v=11.23','./email-assistant.js?v=11.23','./acceptance.js?v=11.23','./custom-selects.js?v=11.23',
  './cloud-auth.js?v=11.23','./manifest.json','./icon-192.svg','./icon-512.svg'
];
