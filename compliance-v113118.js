/* AngebotsPilot v11.31.18 – serverseitige XRechnungs-Validierung
...
(function installServerXRechnungValidation(){
  ...
  const RUNTIME_VERSION='11.31.18';
  ...
  // v11.31.18: UBL MonetaryTotal hat eine feste Elementreihenfolge.
  ...
  function install(base){
    ...
    async function validatorJob(inv){
      ...
      return{
        ...
        xmlFixes:{legalMonetaryTotalOrder:'v11.31.18'}
      };
    }
  ...
  const timer=setInterval(()=>{
    ...
    if(tries>200){clearInterval(timer);console.error('AngebotsPilot v11.31.18 Server-Validierung konnte nicht installiert werden.')}
  },50);
