/* AngebotsPilot v11.31.26 – serverseitige XRechnungs-Validierung
...
(function installServerXRechnungValidation(){
  ...
  const RUNTIME_VERSION='11.31.26';
  ...
  // v11.31.26: UBL MonetaryTotal hat eine feste Elementreihenfolge.
  ...
  function install(base){
    ...
    // v11.31.26 darf auch über 11.31.18/19 gelegt werden: die XML-Normalisierung
    ...
    if(![BASE_VERSION,'11.31.16','11.31.17','11.31.18','11.31.19','11.31.20','11.31.21','11.31.22','11.31.23','11.31.24','11.31.25'].includes(base.runtimeVersion))return false;
    ...
    function check(inv){
      // v11.31.26: wichtig – den unveränderten Basis-Check aufrufen.
    ...
    async function validatorJob(inv){
      ...
      return{
        ...
        xmlFixes:{legalMonetaryTotalOrder:'v11.31.26',inputReadiness:'tax-id-and-iban',sellerIdentifier:'BT-29-normalized-after-EndpointID',loaderFix:'current-layer-v11.31.26',localPreflight:'before-server',recursionFix:'v11.31.26',loaderUpgrade:'forced-current-server-layer'}
      };
    }
    ...
    window.dispatchEvent(new CustomEvent('angebotspilot:compliance-ready',{detail:{
      ...
      xmlSchemaFix:'LegalMonetaryTotal-order',sellerIdentifier:'BT-29-normalized-after-EndpointID',inputReadiness:'tax-id-and-iban',localPreflight:'before-server',recursionFix:true
    }}));
  ...
  globalThis.APComplianceUpgradeTo113126=install;

  let tries=0;
  const timer=setInterval(()=>{
    tries++;
    if(install(globalThis.APCompliance)){clearInterval(timer);return}
    if(tries>200){clearInterval(timer);console.error('AngebotsPilot v11.31.26 Server-Validierung konnte nicht installiert werden.')}
  },50);
